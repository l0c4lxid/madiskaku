...
<head>
  ...
  <title>SiMadiska - Lupa Kata Sandi</title>
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="<?= base_url('assets/image/login/images.png') ?>" width="100%">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?= base_url('login/register') ?>">Daftar Jadi Member!</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="<?= base_url('login') ?>">Sudah Punya Akun? Silahkan Masuk!</a>
                  </div>
                  <div class="text-center">
